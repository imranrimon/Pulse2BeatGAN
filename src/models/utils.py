...
class UNetDown(nn.Module):
    def __init__(self, in_size, out_size, ksize=4, stride=2, normalize=True, dropout=0.0):
        ...
        layers = [nn.Conv1d(in_size, out_size, kernel_size=3,padding=1,
...
class UNetUp(nn.Module):
    def __init__(self, in_size, out_size, ksize=4, stride=2, output_padding=1, dropout=0.0):
        super(UNetUp, self).__init__()
        layers = [
            nn.ConvTranspose1d(in_size, out_size, kernel_size=3,padding=1,
...
class GeneratorUNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1):
        ...
        self.up2 = UNetUp(1024, 256, output_padding=1)
